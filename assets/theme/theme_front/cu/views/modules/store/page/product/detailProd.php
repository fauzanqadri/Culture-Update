	...
	<div class="product_media">
		<? $defimg = element('media', $prod); $m = element('medias', $prod);?>
			...
			<div class="currentImg left">
				<a href='<?=site_url('thumb/show/1200-600-crop/dir/assets/product-img/'.$defimg->path);?>' 
					class = 'cloud-zoom' 
					id='zoom1'
					rel="position: 'inside' ,tint: '#ffffff',tintOpacity:0.5 ,smoothMove:10,zoomWidth:300,zoomHeight:400">
	            	<img  src="<?=site_url('thumb/show/600-300-crop/dir/assets/product-img/'.$defimg->path);?>"
			...
			<?if($m){?>
				<div class="otherImg left">
					<?foreach($m as $med){?>
						<div class="item left">
						<a href='<?=site_url('thumb/show/1200-600-crop/dir/assets/product-img/'.$med->path);?>' 
							class='cloud-zoom-gallery' 
							title='<?=$med->name;?>'
							rel="useZoom: 'zoom1', smallImage: '<?=site_url('thumb/show/600-300-crop/dir/assets/product-img/'.$med->path);?>' ">
		        			<img src="<?=site_url('thumb/show/100-100-crop/dir/assets/product-img/'.$med->path);?>"   
								alt ="<?=$med->name;?>"/>
						</a>
						</div>
