...
<body id="<?=$this->router->class.'_'.$this->router->method;?>" class="checkout">

	<div class="wrapper">
		<div class="inner_wrap ctr grid_700">
			<div class="header">
				<div class="logo ctr">
					<img src="<?=base_url();?>/assets/theme/front/img/top_logo_width.png" width="700" alt="Top Logo Width">
				</div>
			</div>
