    ...
    c.extend(c.validator, {
        defaults: {
            ...
            highlight: function (a, b, d) {
                a.type === "radio" ? this.findByName(a.name).addClass(b, 1000).removeClass(d) : c(a).addClass(b, 1000).removeClass(d)
            },
            unhighlight: function (a, b, d) {
                a.type === "radio" ? this.findByName(a.name).removeClass(b, 1000).addClass(d) : c(a).removeClass(b, 1000).addClass(d)
            }
        },
        ...
        messages: {
			...
			notsame : "This field is required.",
        },
        ...
        prototype: {
            ...
            showLabel: function (a, b) {
                ...
                if (d.length) {
                    ...
                    this.labelContainer.append(d).length || (this.settings.errorPlacement ? this.settings.errorPlacement(d, c(a)) : d.insertAfter(a).show('slide', {direction:'up'}))
                }
